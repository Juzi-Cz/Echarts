...
script = soup.find(id="getStatisticsService")
script_data= script.string
#利用正则提取数据，是json字符串
json_str = re.findall(r'= (\{.+\})}catch',script_data)[0]
#将json字符串转为python数据
py_data = json.loads(json_str)
# print(py_data)
# #将python数据保存到文件
with open('./public/data/getStatisticsService.json','w',encoding='utf8') as fp:
